    ...
    private String requestNewToken() throws IOException {
        ...
        try {
            ...
            if (responseCode != HttpURLConnection.HTTP_OK) {
                ...
                String errorResponse = es != null ? new String(es.readAllBytes(), StandardCharsets.UTF_8) : "(no error body)";
            ...
            logger.info("OAuth2 access token obtained (expires in " + expiresIn + "s)");
            return accessToken;
        } finally {
            conn.disconnect();
        }
