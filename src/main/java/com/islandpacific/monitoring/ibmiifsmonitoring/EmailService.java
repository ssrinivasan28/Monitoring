...
public class EmailService {
    ...
    private void sendEmailViaSMTP(String locationName, String folderPath, String subject, String bodyContent,
        ...
        try {
            ...
            // Build HTML content for the email body, passing the full subject for the HTML
            // heading
            // For SMTP, use cid:logo reference
            String htmlBody = buildEmailHtmlContent(locationName, folderPath, subject, bodyContent, false);
            ...
            // prefix for decoding)
            // This is where the IllegalArgumentException can occur if the string is not
            // valid Base64.
            ...
            logger.log(Level.SEVERE, String.format(
                    "Base64 decoding error for logo for location '%s': %s. Please check the DEFAULT_LOGO_BASE64 string.",
                    locationName, e.getMessage()), e);
