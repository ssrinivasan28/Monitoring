...
public class EmailService {
    ...
    private void sendEmailViaSMTP(FileSystemErrorConfig.MonitoringConfig config,
        ...
        try {
            ...
            String htmlContent = buildEmailHtmlContent(locationName, folderPath, newFilesForLocation, false);
    ...
    private String buildEmailHtmlContent(String locationName, String folderPath,
            Map<String, List<String>> newFilesForLocation, boolean useDataUri) {
        ...
        for (Map.Entry<String, List<String>> entry : newFilesForLocation.entrySet()) {
            ...
            fileListHtml.append(String.format("<h4>New %s Files:</h4><ul>", fileType));
            for (String file : files) {
                fileListHtml.append(String.format("<li>%s</li>", file));
            }
        ...
        htmlBodyBuilder.append("</td>")
                ...
                .append(fileListHtml.toString())
                .append("<p>Please investigate these files as soon as possible.</p>")
