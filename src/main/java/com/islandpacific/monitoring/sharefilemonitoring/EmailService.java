...
public class EmailService {
    ...
    public EmailService(Properties emailProperties, String clientName) {
        ...
        String method = emailProperties.getProperty("mail.auth.method", "SMTP").toUpperCase();
        ...
        if ("OAUTH2".equals(method)) {
            ...
            if (tenantId != null && clientId != null && clientSecret != null) {
                ...
                String provided = emailProperties.getProperty("mail.oauth2.graph.mail.url", "");
                graphUrl = (!provided.isBlank()) ? provided.trim()
    ...
    public void sendEmail(String locationName, String remotePath, String subject, String body, String importance) {
        ...
        if ("OAUTH2".equals(authMethod) && oauth2TokenProvider != null && graphMailUrl != null) {
            sendViaGraph(locationName, remotePath, subject, body, importance);
        } else {
            sendViaSMTP(locationName, remotePath, subject, body, importance);
        }
    }
    ...
    private void sendViaGraph(String locationName, String remotePath, String subject, String body, String importance) {
        try {
            ...
            logger.log(Level.SEVERE, "Failed to send email via Graph for '" + locationName + "': " + e.getMessage(), e);
        }
    }

    private void sendViaSMTP(String locationName, String remotePath, String subject, String body, String importance) {
        ...
        try {
            ...
            Session session;
            if ("true".equalsIgnoreCase(emailProperties.getProperty("mail.smtp.auth")) && user != null && pass != null) {
            ...
            Transport.send(msg);
            logger.info("Email sent via SMTP for '" + locationName + "'");
        } catch (MessagingException e) {
            logger.log(Level.SEVERE, "SMTP send failed for '" + locationName + "': " + e.getMessage(), e);
        }
    }
