...
import java.util.Date; // Explicitly use java.util.Date to avoid ambiguity if java.sql.Date is also present
...
public class EmailService {
    ...
    public void sendEmailAlert(MessageInfo messageData, String subject) {
        ...
        String port = emailProperties.getProperty("mail.smtp.port", "25"); // Default to port 25 if not specified
        String from = emailProperties.getProperty("mail.from");
        ...
        String emailImportance = emailProperties.getProperty("mail.importance", "Normal"); // Use configured importance
    ...
    private void sendEmailAlertViaSMTP(MessageInfo messageData, String subject) {
        ...
        final String username = emailProperties.getProperty("mail.smtp.username");
        final String password = emailProperties.getProperty("mail.smtp.password");
        String emailImportance = emailProperties.getProperty("mail.importance", "Normal");
