...
public class OAuth2TokenProvider {
     ...
     * @param scope        OAuth2 scope (typically
     *                     https://graph.microsoft.com/.default)
     * @param tokenUrl     Custom token URL (optional, will use default Azure AD URL
     *                     if empty)
     */
    ...
    private String refreshAccessToken() throws Exception {
        ...
        try {
            ...
            if (responseCode >= 200 && responseCode < 300) {
                ...
                String errorMsg = "Failed to acquire OAuth2 token. HTTP " + responseCode + ": "
    ...
    /**
     * Invalidates the cached token, forcing a refresh on next getAccessToken()
     * call.
     */
