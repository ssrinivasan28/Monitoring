...
/**
 * HTTP server for exposing Prometheus metrics for IBM SQL Threshold Monitor.
 */
public class SqlThresholdAppServer {

    private static final String METRICS_PATH = "/metrics";
    private HttpServer server;
    private final Logger parentLogger;

    public SqlThresholdAppServer(Logger parentLogger, int port) {
