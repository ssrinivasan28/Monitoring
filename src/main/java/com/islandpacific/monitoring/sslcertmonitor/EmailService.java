...
public class EmailService {
    ...
    private String buildHtmlEmail(String accentColor, String badge, String badgeBg, String badgeText,
        ...
        sb.append("<!DOCTYPE html><html><head><meta charset=\"utf-8\"><style>")
          ...
          .append("<div class='logo-bar'><img src='").append(DEFAULT_LOGO_BASE64).append("' alt='Island Pacific' style='display:block;max-width:150px;height:50px;object-fit:contain'/></div>")
