...
public class EmailService {
    ...
    public EmailService(Properties emailProperties, String clientName, String logoPath) {
        ...
        this.authMethod = emailProperties.getProperty("mail.auth.method", "SMTP").toUpperCase();
        ...
        if ("OAUTH2".equals(this.authMethod)) {
            ...
            String configuredFrom = emailProperties.getProperty("mail.from", "");
    ...
    private void sendViaGraphAPI(Map<String, String> disabledUsers, String eventTimestamp,
        ...
        try {
            ...
            String htmlBody = buildDisabledAlertHtml(disabledUsers, eventTimestamp, systemName, clientName);
    ...
    private String buildDisabledAlertHtml(Map<String, String> disabledUsers,
        ...
        html.append("<div class='header'><img src='").append(buildLogoDataUri())
