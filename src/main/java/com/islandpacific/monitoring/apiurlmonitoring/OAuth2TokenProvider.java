...
public class OAuth2TokenProvider {
    ...
    public synchronized String getAccessToken() throws IOException {
        ...
        if (responseCode >= 200 && responseCode < 300) {
            ...
            String error = es != null ? new String(es.readAllBytes(), StandardCharsets.UTF_8) : "(no error body)";
            throw new IOException("Failed to acquire OAuth2 token. Code: " + responseCode + ", Error: " + error);
        }
    }
}
